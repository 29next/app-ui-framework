...
```html
<link href="https://cdn.jsdelivr.net/gh/29next/app-ui-framework@0.0.6/dist/css/next-app-ui.min.css" rel="stylesheet" crossorigin="anonymous">
```

```html
<script src="https://cdn.jsdelivr.net/gh/29next/app-ui-framework@0.0.6/dist/js/next-app-ui.min.js"></script>
```
